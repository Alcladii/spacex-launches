...
export const FavoriteButton = ({
  ...
  const handleClick = () => {
    setAnim(isFavorite ? "unpop" : "pop");

    onToggle();

    setTimeout(() => setAnim(null), isFavorite ? 180 : 260);
  };
    ...
    <button type="button" onClick={handleClick} className="p-1">
      ...
      >
        <path
          ...
          ${anim === "pop" ? "favorite-pop" : ""}
          ${anim === "unpop" ? "favorite-unpop" : ""}
          ${
            isFavorite
              ? "fill-red-500 stroke-red-500"
              : "fill-transparent stroke-heart-stroke"
          }`}
